...
public enum ModArmorMaterials implements ArmorMaterial {
	...
	COPPER("copper", 10, new int[]{2, 4, 3, 2}, 9, SoundEvents.ARMOR_EQUIP_CHAIN, 0.0F, 0.0F, () -> Ingredient.of(Items.COPPER_INGOT));
	...
	private static final int[] BASE_DURABILITY = {2, 4, 3, 2};
